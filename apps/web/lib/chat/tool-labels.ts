...
const TOOL_LABELS: Record<string, string> = {
  ...
  get_basis: "Calcular basis spot-perp",
  get_btc_correlation: "Medir correlación con BTC",
  get_funding_rate: "Consultar funding rate",
  get_indicators: "Calcular indicadores",
  get_market_dominance: "Leer dominance macro-cripto",
  get_market_structure: "Analizar estructura",
  get_multi_tf_confluence: "Evaluar confluencia",
  get_ohlcv: "Cargar velas",
  get_open_interest: "Consultar open interest",
  get_perps_dynamics: "Analizar dinámica de perps",
  get_similar_past_setups: "Buscar setups similares",
  get_similar_past_trades: "Buscar trades similares",
  get_strategy_metrics: "Métricas de estrategia",
  get_volume_profile: "Calcular volume profile",
  journal_query: "Buscar en el diario",
  list_alerts: "Listar alertas",
  log_trade: "Registrar operación",
  run_backtest: "Ejecutar backtest",
  run_cpcv: "Ejecutar CPCV",
  run_walk_forward: "Ejecutar walk-forward",
}
